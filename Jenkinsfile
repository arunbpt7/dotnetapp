     ...
     stage('Email Notification' ) {
      ...
      stage('Deployment completion  ' ) {
        steps{
         ...
         emailext body: 'Application has been deployed  and available through "http://dotnettest.apps.ux.hra.nycnet" ', subject: 'Jenkins | completed  | Success  ', to: 'babuar@dss.nyc.gov'
       }
     }       
   }
 }
